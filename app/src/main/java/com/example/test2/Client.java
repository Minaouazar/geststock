...
public class Client extends AppCompatActivity {
    ...
    EditText _nom, _prenom,_numtel,_adresse,_txtRechercheClient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _txtRechercheClient = (EditText) findViewById(R.id.txtRecherchevent);
       ...
       /* awesomeValidation =new AwesomeValidation(ValidationStyle.BASIC);
        ...
        _btnRecherche.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                cur = db.rawQuery("select * from Utilisateur where Nom like ?", new String[]{"%" + _txtRechercheClient.getText().toString() + "%"});
                try {
                    cur.moveToFirst();
            ...
            public void onClick(View view) {
                ...
                if (op == 1){
                    ...
                    if (_nom.getText().toString().equals("") || _prenom.getText().toString().equals("") || _numtel.getText().toString().equals("")|| _adresse.getText().toString().equals("")) {
                        Toast.makeText(Client.this, "il manque des information", Toast.LENGTH_SHORT).show();
                    } else  {
